...
/tmp/claude-1001/-home-jacob-z-tinygrad/bbbf3962-a9cf-4c32-800a-58c69b1ea8de/scratchpad/isa/attn_prep_24_4_256_64_8204_11_k4jv4�_66630eee.elf:	file format elf64-amdgpu
...
0000000000000000 <attn_prep_24_4_256_64_8204_11_k4jv4>:
	...
	s_cbranch_scc1 2365                                        // 000000000020: BFA2093D <attn_prep_24_4_256_64_8204_11_k4jv4+0x2518>
	...
	s_add_i32 s29, s29, s12                                    // 000000000A80: 811D0C1D
	v_and_b32_e32 v6, 31, v0                                   // 000000000A84: 360C009F
	s_cmpk_lt_u32 s29, 0x200c                                  // 000000000A88: B69D200C
	s_waitcnt lgkmcnt(0)                                       // 000000000A8C: BF89FC07
	s_cselect_b32 s8, s29, 0                                   // 000000000A90: 9808801D
	s_barrier                                                  // 000000000A94: BFBD0000
	s_ashr_i32 s9, s8, 31                                      // 000000000A98: 86099F08
	buffer_gl0_inv                                             // 000000000A9C: E0AC0000 00000000
	s_lshl_b64 s[6:7], s[8:9], 8                               // 000000000AA4: 84868808
	s_delay_alu instid0(SALU_CYCLE_1)                          // 000000000AA8: BF870009
	s_add_u32 s6, s2, s6                                       // 000000000AAC: 80060602
	s_addc_u32 s7, s3, s7                                      // 000000000AB0: 82070703
	s_and_saveexec_b32 s1, s0                                  // 000000000AB4: BE812000
	s_cbranch_execz 25                                         // 000000000AB8: BFA50019 <attn_prep_24_4_256_64_8204_11_k4jv4+0xb20>
	v_lshlrev_b32_e32 v3, 2, v6                                // 000000000ABC: 30060C82
	s_clause 0x1                                               // 000000000AC0: BF850001
	global_load_b32 v5, v3, s[6:7] offset:128                  // 000000000AC4: DC520080 05060003
	global_load_b32 v9, v3, s[6:7]                             // 000000000ACC: DC520000 09060003
	v_lshl_or_b32 v7, v1, 10, v3                               // 000000000AD4: D6560007 040D1501
	ds_load_2addr_b32 v[7:8], v7 offset1:32                    // 000000000ADC: D8DC2000 07000007
	s_waitcnt vmcnt(1) lgkmcnt(0)                              // 000000000AE4: BF890407
	v_mul_f32_e32 v10, v5, v8                                  // 000000000AE8: 10141105
	v_mul_f32_e32 v5, v5, v7                                   // 000000000AEC: 100A0F05
	v_lshl_or_b32 v3, v1, 8, v3                                // 000000000AF0: D6560003 040D1101
	s_waitcnt vmcnt(0)                                         // 000000000AF8: BF8903F7
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000000AFC: BF870193
	v_fma_f32 v7, v9, v7, -v10                                 // 000000000B00: D6130007 842A0F09
	v_fmac_f32_e32 v5, v9, v8                                  // 000000000B08: 560A1109
	s_delay_alu instid0(VALU_DEP_3)                            // 000000000B0C: BF870003
	v_add_nc_u32_e32 v3, 0x3800, v3                            // 000000000B10: 4A0606FF 00003800
	ds_store_2addr_b32 v3, v7, v5 offset1:32                   // 000000000B18: D8382000 00050703
	s_or_b32 exec_lo, exec_lo, s1                              // 000000000B20: 8C7E017E
	v_cmp_gt_u32_e64 s2, 32, v0                                // 000000000B24: D44C0002 000200A0
	v_dual_mov_b32 v5, 0 :: v_dual_mov_b32 v8, 0               // 000000000B2C: CA100080 05080080
	v_lshlrev_b32_e32 v3, 2, v0                                // 000000000B34: 30060082
	s_delay_alu instid0(VALU_DEP_3)                            // 000000000B38: BF870003
	s_and_saveexec_b32 s1, s2                                  // 000000000B3C: BE812002
	s_cbranch_execz 17                                         // 000000000B40: BFA50011 <attn_prep_24_4_256_64_8204_11_k4jv4+0xb88>
	s_clause 0x1                                               // 000000000B44: BF850001
	global_load_b32 v9, v3, s[6:7] offset:128                  // 000000000B48: DC520080 09060003
	global_load_b32 v10, v3, s[6:7]                            // 000000000B50: DC520000 0A060003
	v_add_nc_u32_e32 v5, 0x3000, v3                            // 000000000B58: 4A0A06FF 00003000
	ds_load_2addr_b32 v[7:8], v5 offset1:32                    // 000000000B60: D8DC2000 07000005
	s_waitcnt vmcnt(1) lgkmcnt(0)                              // 000000000B68: BF890407
	v_mul_f32_e32 v11, v9, v8                                  // 000000000B6C: 10161109
	s_waitcnt vmcnt(0)                                         // 000000000B70: BF8903F7
	v_mul_f32_e32 v5, v10, v8                                  // 000000000B74: 100A110A
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000000B78: BF870112
	v_fma_f32 v8, v10, v7, -v11                                // 000000000B7C: D6130008 842E0F0A
	v_fmac_f32_e32 v5, v9, v7                                  // 000000000B84: 560A0F09
	s_or_b32 exec_lo, exec_lo, s1                              // 000000000B88: 8C7E017E
	v_and_b32_e32 v7, 63, v0                                   // 000000000B8C: 360E00BF
	v_or_b32_e32 v13, 0xffffff00, v0                           // 000000000B90: 381A00FF FFFFFF00
	s_mov_b32 s1, exec_lo                                      // 000000000B98: BE81007E
	s_waitcnt lgkmcnt(0)                                       // 000000000B9C: BF89FC07
	s_barrier                                                  // 000000000BA0: BFBD0000
	buffer_gl0_inv                                             // 000000000BA4: E0AC0000 00000000
	v_cmpx_gt_u32_e32 0x180, v0                                // 000000000BAC: 7D9800FF 00000180
	s_cbranch_execz 30                                         // 000000000BB4: BFA5001E <attn_prep_24_4_256_64_8204_11_k4jv4+0xc30>
	v_lshrrev_b32_e32 v10, 6, v0                               // 000000000BB8: 32140086
	v_lshlrev_b32_e32 v11, 2, v7                               // 000000000BBC: 30160E82
	v_or_b32_e32 v9, 0xffffff00, v0                            // 000000000BC0: 381200FF FFFFFF00
	s_mov_b32 s3, 0                                            // 000000000BC8: BE830080
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000000BCC: BF870193
	v_lshlrev_b32_e32 v12, 8, v10                              // 000000000BD0: 30181488
	v_lshl_or_b32 v10, v10, 10, v11                            // 000000000BD4: D656000A 042D150A
	s_delay_alu instid0(VALU_DEP_2)                            // 000000000BDC: BF870002
	v_or3_b32 v11, v12, v11, 0x3800                            // 000000000BE0: D658000B 03FE170C 00003800
	ds_load_b32 v12, v11                                       // 000000000BEC: D8D80000 0C00000B
	v_add_nc_u32_e32 v9, 0x100, v9                             // 000000000BF4: 4A1212FF 00000100
	v_add_nc_u32_e32 v11, 0x400, v11                           // 000000000BFC: 4A1616FF 00000400
	s_delay_alu instid0(VALU_DEP_2)                            // 000000000C04: BF870002
	v_cmp_lt_u32_e32 vcc_lo, 0x7f, v9                          // 000000000C08: 7C9212FF 0000007F
	s_or_b32 s3, vcc_lo, s3                                    // 000000000C10: 8C03036A
	s_waitcnt lgkmcnt(0)                                       // 000000000C14: BF89FC07
	ds_store_b32 v10, v12                                      // 000000000C18: D8340000 00000C0A
	v_add_nc_u32_e32 v10, 0x1000, v10                          // 000000000C20: 4A1414FF 00001000
	s_and_not1_b32 exec_lo, exec_lo, s3                        // 000000000C28: 917E037E
	s_cbranch_execnz 65519                                     // 000000000C2C: BFA6FFEF <attn_prep_24_4_256_64_8204_11_k4jv4+0xbec>
	s_or_b32 exec_lo, exec_lo, s1                              // 000000000C30: 8C7E017E
	s_and_saveexec_b32 s1, s2                                  // 000000000C34: BE812002
	v_add_nc_u32_e32 v9, 0x3000, v3                            // 000000000C38: 4A1206FF 00003000
	ds_store_2addr_b32 v9, v8, v5 offset1:32                   // 000000000C40: D8382000 00050809
	s_or_b32 exec_lo, exec_lo, s1                              // 000000000C48: 8C7E017E
	v_xor_b32_e32 v5, 0x1234567, v0                            // 000000000C4C: 3A0A00FF 01234567
	v_xor_b32_e32 v8, 0x7654321, v0                            // 000000000C54: 3A1000FF 07654321
	s_mov_b32 s6, 0                                            // 000000000C5C: BE860080
	s_waitcnt lgkmcnt(0)                                       // 000000000C60: BF89FC07
	s_barrier                                                  // 000000000C64: BFBD0000
	v_mul_lo_u32 v5, 0x9e3779b1, v5                            // 000000000C68: D72C0005 00020AFF 9E3779B1
	v_mul_lo_u32 v8, 0x9e3779b1, v8                            // 000000000C74: D72C0008 000210FF 9E3779B1
	buffer_gl0_inv                                             // 000000000C80: E0AC0000 00000000
	v_bcnt_u32_b32 v5, v5, 0                                   // 000000000C88: D71E0005 00010105
	v_bcnt_u32_b32 v8, v8, 0                                   // 000000000C90: D71E0008 00010108
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000000C98: BF870112
	v_and_b32_e32 v9, 1, v5                                    // 000000000C9C: 36120A81
	v_and_b32_e32 v8, 1, v8                                    // 000000000CA0: 36101081
	v_or_b32_e32 v5, 0xffffe800, v3                            // 000000000CA4: 380A06FF FFFFE800
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)// 000000000CAC: BF870223
	v_cmp_eq_u32_e32 vcc_lo, 0, v9                             // 000000000CB0: 7C941280
	v_mov_b32_e32 v9, v13                                      // 000000000CB4: 7E12030D
	v_cmp_eq_u32_e64 s1, 0, v8                                 // 000000000CB8: D44A0001 00021080
	s_set_inst_prefetch_distance 0x1                           // 000000000CC0: BF840001
	s_branch 28                                                // 000000000CC4: BFA0001C <attn_prep_24_4_256_64_8204_11_k4jv4+0xd38>
	s_nop 0                                                    // 000000000CC8: BF800000
	...
	s_mul_i32 s6, s28, 0x258e10                                // 0000000012C8: 9606FF1C 00258E10
	...
	s_add_u32 s10, s4, s6                                      // 0000000012E8: 800A0604
	s_addc_u32 s11, s5, 0                                      // 0000000012EC: 820B8005
	...
	s_cbranch_execz 12                                         // 0000000015A0: BFA5000C <attn_prep_24_4_256_64_8204_11_k4jv4+0x15d4>
	s_lshl_b32 s6, s8, 1                                       // 0000000015A4: 84068108
	v_mul_f32_e32 v14, 0x3d800000, v15                         // 0000000015A8: 101C1EFF 3D800000
	s_ashr_i32 s7, s6, 31                                      // 0000000015B0: 86079F06
	v_mov_b32_e32 v16, 0x140000                                // 0000000015B4: 7E2002FF 00140000
	s_lshl_b64 s[6:7], s[6:7], 2                               // 0000000015BC: 84868206
	s_delay_alu instid0(SALU_CYCLE_1)                          // 0000000015C0: BF870009
	s_add_u32 s6, s10, s6                                      // 0000000015C4: 8006060A
	s_addc_u32 s7, s11, s7                                     // 0000000015C8: 8207070B
	global_store_b32 v16, v14, s[6:7] offset:1920              // 0000000015CC: DC6A0780 00060E10
	s_or_b32 exec_lo, exec_lo, s4                              // 0000000015D4: 8C7E047E
	v_add_nc_u32_e32 v16, 0x3e00, v3                           // 0000000015D8: 4A2006FF 00003E00
	v_add_nc_u32_e32 v14, 0x4200, v3                           // 0000000015E0: 4A1C06FF 00004200
	v_cmp_gt_u32_e64 s4, 0x80, v0                              // 0000000015E8: D44C0004 000200FF 00000080
	s_waitcnt lgkmcnt(0)                                       // 0000000015F4: BF89FC07
	s_waitcnt_vscnt null, 0x0                                  // 0000000015F8: BC7C0000
	s_barrier                                                  // 0000000015FC: BFBD0000
	buffer_gl0_inv                                             // 000000001600: E0AC0000 00000000
	s_and_saveexec_b32 s5, s4                                  // 000000001608: BE852004
	s_cbranch_execz 16                                         // 00000000160C: BFA50010 <attn_prep_24_4_256_64_8204_11_k4jv4+0x1650>
	v_lshl_add_u32 v17, v0, 2, v14                             // 000000001610: D6460011 04390500
	s_lshl_b64 s[6:7], s[8:9], 7                               // 000000001618: 84868708
	s_delay_alu instid0(SALU_CYCLE_1)                          // 00000000161C: BF870009
	v_or_b32_e32 v19, s6, v0                                   // 000000001620: 38260006
	v_mov_b32_e32 v20, s7                                      // 000000001624: 7E280207
	ds_load_b64 v[17:18], v17                                  // 000000001628: D9D80000 11000011
	s_waitcnt lgkmcnt(0)                                       // 000000001630: BF89FC07
	v_lshl_or_b32 v21, v18, 4, v17                             // 000000001634: D6560015 04450912
	v_add_co_u32 v17, vcc_lo, s10, v19                         // 00000000163C: D7006A11 0002260A
	v_add_co_ci_u32_e32 v18, vcc_lo, s11, v20, vcc_lo          // 000000001644: 4024280B
	global_store_b8 v[17:18], v21, off                         // 000000001648: DC620000 007C1511
	s_or_b32 exec_lo, exec_lo, s5                              // 000000001650: 8C7E057E
	ds_load_b32 v17, v16                                       // 000000001654: D8D80000 11000010
	s_waitcnt lgkmcnt(0)                                       // 00000000165C: BF89FC07
	v_mul_f32_e32 v18, v17, v17                                // 000000001660: 10242311
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001664: BF870091
	v_mov_b32_dpp v18, v18 row_shr:1 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001668: 7E2402FA FF091112
	v_fmac_f32_e32 v18, v17, v17                               // 000000001670: 56242311
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001674: BF870091
	v_add_f32_dpp v17, v18, v18 row_shr:2 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001678: 062224FA FF091212
	v_add_f32_dpp v17, v17, v17 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001680: 062222FA FF091411
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001688: BF870091
	v_add_f32_dpp v17, v17, v17 row_shr:8 row_mask:0xf bank_mask:0xf bound_ctrl:1// 00000000168C: 062222FA FF091811
	v_readlane_b32 s6, v17, 15                                 // 000000001694: D7600006 00011F11
	v_readlane_b32 s7, v17, 31                                 // 00000000169C: D7600007 00013F11
	s_and_saveexec_b32 s5, s1                                  // 0000000016A4: BE852001
	s_delay_alu instid0(VALU_DEP_1)                            // 0000000016A8: BF870001
	v_add_f32_e64 v17, s6, s7                                  // 0000000016AC: D5030011 00000E06
	ds_store_b32 v13, v17 offset:18048                         // 0000000016B4: D8344680 0000110D
	s_or_b32 exec_lo, exec_lo, s5                              // 0000000016BC: 8C7E057E
	v_mov_b32_e32 v21, 0                                       // 0000000016C0: 7E2A0280
	s_waitcnt lgkmcnt(0)                                       // 0000000016C4: BF89FC07
	s_waitcnt_vscnt null, 0x0                                  // 0000000016C8: BC7C0000
	s_barrier                                                  // 0000000016CC: BFBD0000
	buffer_gl0_inv                                             // 0000000016D0: E0AC0000 00000000
	v_cmp_eq_u32_e64 s5, 0, v8                                 // 0000000016D8: D44A0005 00021080
	ds_load_b128 v[17:20], v21 offset:18048                    // 0000000016E0: DBFC4680 11000015
	ds_load_b128 v[21:24], v21 offset:18064                    // 0000000016E8: DBFC4690 15000015
	ds_load_b32 v25, v16                                       // 0000000016F0: D8D80000 19000010
	s_waitcnt lgkmcnt(2)                                       // 0000000016F8: BF89FC27
	v_add_f32_e32 v17, v17, v18                                // 0000000016FC: 06222511
	s_waitcnt lgkmcnt(0)                                       // 000000001700: BF89FC07
	v_cndmask_b32_e64 v8, -v25, v25, s5                        // 000000001704: D5010008 20163319
	s_delay_alu instid0(VALU_DEP_2)                            // 00000000170C: BF870002
	v_add_f32_e32 v17, v17, v19                                // 000000001710: 06222711
	ds_store_b32 v16, v8                                       // 000000001714: D8340000 00000810
	s_waitcnt lgkmcnt(0)                                       // 00000000171C: BF89FC07
	s_barrier                                                  // 000000001720: BFBD0000
	v_add_f32_e32 v17, v17, v20                                // 000000001724: 06222911
	buffer_gl0_inv                                             // 000000001728: E0AC0000 00000000
	v_add_f32_e32 v17, v17, v21                                // 000000001730: 06222B11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001734: BF870091
	v_add_f32_e32 v17, v17, v22                                // 000000001738: 06222D11
	v_add_f32_e32 v17, v17, v23                                // 00000000173C: 06222F11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001740: BF870091
	v_add_f32_e32 v17, v17, v24                                // 000000001744: 06223111
	v_mul_f32_e32 v18, 0x4f800000, v17                         // 000000001748: 102422FF 4F800000
	v_cmp_gt_f32_e32 vcc_lo, 0xf800000, v17                    // 000000001750: 7C2822FF 0F800000
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001758: BF870092
	v_cndmask_b32_e32 v17, v17, v18, vcc_lo                    // 00000000175C: 02222511
	v_sqrt_f32_e32 v18, v17                                    // 000000001760: 7E246711
	s_waitcnt_depctr 0xfff                                     // 000000001764: BF880FFF
	v_add_nc_u32_e32 v20, -1, v18                              // 000000001768: 4A2824C1
	v_add_nc_u32_e32 v19, 1, v18                               // 00000000176C: 4A262481
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001770: BF870112
	v_fma_f32 v21, -v20, v18, v17                              // 000000001774: D6130015 24462514
	v_fma_f32 v22, -v19, v18, v17                              // 00000000177C: D6130016 24462513
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001784: BF870112
	v_cmp_ge_f32_e64 s5, 0, v21                                // 000000001788: D4160005 00022A80
	v_cmp_lt_f32_e64 s6, 0, v22                                // 000000001790: D4110006 00022C80
	s_and_saveexec_b32 s7, s4                                  // 000000001798: BE872004
	s_cbranch_execz 9                                          // 00000000179C: BFA50009 <attn_prep_24_4_256_64_8204_11_k4jv4+0x17c4>
	v_lshl_add_u32 v8, v0, 2, v16                              // 0000000017A0: D6460008 04410500
	ds_load_b64 v[21:22], v8                                   // 0000000017A8: D9D80000 15000008
	s_waitcnt lgkmcnt(0)                                       // 0000000017B0: BF89FC07
	v_add_f32_e32 v23, v21, v22                                // 0000000017B4: 062E2D15
	v_sub_f32_e32 v24, v21, v22                                // 0000000017B8: 08302D15
	ds_store_b64 v8, v[23:24]                                  // 0000000017BC: D9340000 00001708
	s_or_b32 exec_lo, exec_lo, s7                              // 0000000017C4: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 0000000017C8: BF89FC07
	s_barrier                                                  // 0000000017CC: BFBD0000
	buffer_gl0_inv                                             // 0000000017D0: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 0000000017D8: BE872004
	s_cbranch_execz 14                                         // 0000000017DC: BFA5000E <attn_prep_24_4_256_64_8204_11_k4jv4+0x1818>
	v_and_or_b32 v8, 0xfc, v5, v9                              // 0000000017E0: D6570008 04260AFF 000000FC
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000017EC: BF870091
	v_lshlrev_b32_e32 v8, 2, v8                                // 0000000017F0: 30101082
	v_add_nc_u32_e32 v21, 0x3c00, v8                           // 0000000017F4: 4A2A10FF 00003C00
	ds_load_2addr_b32 v[8:9], v21 offset0:128 offset1:130      // 0000000017FC: D8DC8280 08000015
	s_waitcnt lgkmcnt(0)                                       // 000000001804: BF89FC07
	v_add_f32_e32 v22, v8, v9                                  // 000000001808: 062C1308
	v_sub_f32_e32 v8, v8, v9                                   // 00000000180C: 08101308
	ds_store_2addr_b32 v21, v22, v8 offset0:128 offset1:130    // 000000001810: D8388280 00081615
	s_or_b32 exec_lo, exec_lo, s7                              // 000000001818: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 00000000181C: BF89FC07
	s_barrier                                                  // 000000001820: BFBD0000
	buffer_gl0_inv                                             // 000000001824: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 00000000182C: BE872004
	s_cbranch_execz 14                                         // 000000001830: BFA5000E <attn_prep_24_4_256_64_8204_11_k4jv4+0x186c>
	v_and_or_b32 v8, 0xf8, v5, v10                             // 000000001834: D6570008 042A0AFF 000000F8
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001840: BF870091
	v_lshlrev_b32_e32 v8, 2, v8                                // 000000001844: 30101082
	v_add_nc_u32_e32 v10, 0x3c00, v8                           // 000000001848: 4A1410FF 00003C00
	ds_load_2addr_b32 v[8:9], v10 offset0:128 offset1:132      // 000000001850: D8DC8480 0800000A
	s_waitcnt lgkmcnt(0)                                       // 000000001858: BF89FC07
	v_add_f32_e32 v21, v8, v9                                  // 00000000185C: 062A1308
	v_sub_f32_e32 v8, v8, v9                                   // 000000001860: 08101308
	ds_store_2addr_b32 v10, v21, v8 offset0:128 offset1:132    // 000000001864: D8388480 0008150A
	s_or_b32 exec_lo, exec_lo, s7                              // 00000000186C: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 000000001870: BF89FC07
	s_barrier                                                  // 000000001874: BFBD0000
	buffer_gl0_inv                                             // 000000001878: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 000000001880: BE872004
	s_cbranch_execz 14                                         // 000000001884: BFA5000E <attn_prep_24_4_256_64_8204_11_k4jv4+0x18c0>
	v_and_or_b32 v8, 0xf0, v5, v11                             // 000000001888: D6570008 042E0AFF 000000F0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001894: BF870091
	v_lshlrev_b32_e32 v8, 2, v8                                // 000000001898: 30101082
	v_add_nc_u32_e32 v10, 0x3c00, v8                           // 00000000189C: 4A1410FF 00003C00
	ds_load_2addr_b32 v[8:9], v10 offset0:128 offset1:136      // 0000000018A4: D8DC8880 0800000A
	s_waitcnt lgkmcnt(0)                                       // 0000000018AC: BF89FC07
	v_add_f32_e32 v11, v8, v9                                  // 0000000018B0: 06161308
	v_sub_f32_e32 v8, v8, v9                                   // 0000000018B4: 08101308
	ds_store_2addr_b32 v10, v11, v8 offset0:128 offset1:136    // 0000000018B8: D8388880 00080B0A
	s_or_b32 exec_lo, exec_lo, s7                              // 0000000018C0: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 0000000018C4: BF89FC07
	s_barrier                                                  // 0000000018C8: BFBD0000
	buffer_gl0_inv                                             // 0000000018CC: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 0000000018D4: BE872004
	s_cbranch_execz 14                                         // 0000000018D8: BFA5000E <attn_prep_24_4_256_64_8204_11_k4jv4+0x1914>
	v_and_or_b32 v8, 0xe0, v5, v12                             // 0000000018DC: D6570008 04320AFF 000000E0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000018E8: BF870091
	v_lshlrev_b32_e32 v8, 2, v8                                // 0000000018EC: 30101082
	v_add_nc_u32_e32 v10, 0x3c00, v8                           // 0000000018F0: 4A1410FF 00003C00
	ds_load_2addr_b32 v[8:9], v10 offset0:128 offset1:144      // 0000000018F8: D8DC9080 0800000A
	s_waitcnt lgkmcnt(0)                                       // 000000001900: BF89FC07
	v_add_f32_e32 v11, v8, v9                                  // 000000001904: 06161308
	v_sub_f32_e32 v8, v8, v9                                   // 000000001908: 08101308
	ds_store_2addr_b32 v10, v11, v8 offset0:128 offset1:144    // 00000000190C: D8389080 00080B0A
	s_or_b32 exec_lo, exec_lo, s7                              // 000000001914: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 000000001918: BF89FC07
	s_barrier                                                  // 00000000191C: BFBD0000
	buffer_gl0_inv                                             // 000000001920: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 000000001928: BE872004
	s_cbranch_execz 14                                         // 00000000192C: BFA5000E <attn_prep_24_4_256_64_8204_11_k4jv4+0x1968>
	v_and_or_b32 v6, 0xc0, v5, v6                              // 000000001930: D6570006 041A0AFF 000000C0
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 00000000193C: BF870091
	v_lshlrev_b32_e32 v6, 2, v6                                // 000000001940: 300C0C82
	v_add_nc_u32_e32 v6, 0x3c00, v6                            // 000000001944: 4A0C0CFF 00003C00
	ds_load_2addr_b32 v[8:9], v6 offset0:128 offset1:160       // 00000000194C: D8DCA080 08000006
	s_waitcnt lgkmcnt(0)                                       // 000000001954: BF89FC07
	v_add_f32_e32 v10, v8, v9                                  // 000000001958: 06141308
	v_sub_f32_e32 v8, v8, v9                                   // 00000000195C: 08101308
	ds_store_2addr_b32 v6, v10, v8 offset0:128 offset1:160     // 000000001960: D838A080 00080A06
	s_or_b32 exec_lo, exec_lo, s7                              // 000000001968: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 00000000196C: BF89FC07
	s_barrier                                                  // 000000001970: BFBD0000
	buffer_gl0_inv                                             // 000000001974: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 00000000197C: BE872004
	s_cbranch_execz 12                                         // 000000001980: BFA5000C <attn_prep_24_4_256_64_8204_11_k4jv4+0x19b4>
	v_and_or_b32 v6, 0x80, v5, v7                              // 000000001984: D6570006 041E0AFF 00000080
	s_delay_alu instid0(VALU_DEP_1)                            // 000000001990: BF870001
	v_lshlrev_b32_e32 v8, 2, v6                                // 000000001994: 30100C82
	ds_load_2addr_stride64_b32 v[6:7], v8 offset0:62 offset1:63// 000000001998: D8E03F3E 06000008
	s_waitcnt lgkmcnt(0)                                       // 0000000019A0: BF89FC07
	v_add_f32_e32 v9, v6, v7                                   // 0000000019A4: 06120F06
	v_sub_f32_e32 v6, v6, v7                                   // 0000000019A8: 080C0F06
	ds_store_2addr_stride64_b32 v8, v9, v6 offset0:62 offset1:63// 0000000019AC: D83C3F3E 00060908
	s_or_b32 exec_lo, exec_lo, s7                              // 0000000019B4: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 0000000019B8: BF89FC07
	s_barrier                                                  // 0000000019BC: BFBD0000
	buffer_gl0_inv                                             // 0000000019C0: E0AC0000 00000000
	s_and_saveexec_b32 s7, s4                                  // 0000000019C8: BE872004
	s_cbranch_execz 7                                          // 0000000019CC: BFA50007 <attn_prep_24_4_256_64_8204_11_k4jv4+0x19ec>
	ds_load_2addr_stride64_b32 v[6:7], v16 offset1:2           // 0000000019D0: D8E00200 06000010
	s_waitcnt lgkmcnt(0)                                       // 0000000019D8: BF89FC07
	v_add_f32_e32 v8, v6, v7                                   // 0000000019DC: 06100F06
	v_sub_f32_e32 v6, v6, v7                                   // 0000000019E0: 080C0F06
	ds_store_2addr_stride64_b32 v16, v8, v6 offset1:2          // 0000000019E4: D83C0200 00060810
	s_or_b32 exec_lo, exec_lo, s7                              // 0000000019EC: 8C7E077E
	s_waitcnt lgkmcnt(0)                                       // 0000000019F0: BF89FC07
	s_barrier                                                  // 0000000019F4: BFBD0000
	buffer_gl0_inv                                             // 0000000019F8: E0AC0000 00000000
	ds_load_b32 v6, v16                                        // 000000001A00: D8D80000 06000010
	s_waitcnt lgkmcnt(0)                                       // 000000001A08: BF89FC07
	v_cmp_le_f32_e64 s7, 0, v6                                 // 000000001A0C: D4130007 00020C80
	s_delay_alu instid0(VALU_DEP_1)                            // 000000001A14: BF870001
	v_cndmask_b32_e64 v6, 0, 1, s7                             // 000000001A18: D5010006 001D0280
	ds_store_b32 v14, v6                                       // 000000001A20: D8340000 0000060E
	s_waitcnt lgkmcnt(0)                                       // 000000001A28: BF89FC07
	s_barrier                                                  // 000000001A2C: BFBD0000
	buffer_gl0_inv                                             // 000000001A30: E0AC0000 00000000
	s_and_saveexec_b32 s7, s2                                  // 000000001A38: BE872002
	s_cbranch_execz 51                                         // 000000001A3C: BFA50033 <attn_prep_24_4_256_64_8204_11_k4jv4+0x1b0c>
	v_lshlrev_b32_e32 v10, 5, v0                               // 000000001A40: 30140085
	s_lshl_b64 s[14:15], s[8:9], 5                             // 000000001A44: 848E8508
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)// 000000001A48: BF8700A9
	s_add_u32 s2, s14, 0x100600                                // 000000001A4C: 8002FF0E 00100600
	s_addc_u32 s13, s15, 0                                     // 000000001A54: 820D800F
	v_add_nc_u32_e32 v6, 0x420c, v10                           // 000000001A58: 4A0C14FF 0000420C
	v_add_nc_u32_e32 v8, 0x4204, v10                           // 000000001A60: 4A1014FF 00004204
	v_add_nc_u32_e32 v11, 0x4214, v10                          // 000000001A68: 4A1614FF 00004214
	v_add_nc_u32_e32 v12, 0x4000, v10                          // 000000001A70: 4A1814FF 00004000
	ds_load_2addr_b32 v[6:7], v6 offset1:1                     // 000000001A78: D8DC0100 06000006
	ds_load_2addr_b32 v[8:9], v8 offset1:1                     // 000000001A80: D8DC0100 08000008
	ds_load_2addr_b32 v[10:11], v11 offset1:1                  // 000000001A88: D8DC0100 0A00000B
	ds_load_2addr_b32 v[21:22], v12 offset0:128 offset1:135    // 000000001A90: D8DC8780 1500000C
	s_waitcnt lgkmcnt(3)                                       // 000000001A98: BF89FC37
	v_lshlrev_b32_e32 v7, 4, v7                                // 000000001A9C: 300E0E84
	v_lshlrev_b32_e32 v6, 3, v6                                // 000000001AA0: 300C0C83
	s_waitcnt lgkmcnt(2)                                       // 000000001AA4: BF89FC27
	v_lshlrev_b32_e32 v8, 1, v8                                // 000000001AA8: 30101081
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)// 000000001AAC: BF870133
	v_lshl_or_b32 v7, v9, 2, v7                                // 000000001AB0: D6560007 041D0509
	s_waitcnt lgkmcnt(1)                                       // 000000001AB8: BF89FC17
	v_dual_mov_b32 v10, s13 :: v_dual_lshlrev_b32 v9, 5, v10   // 000000001ABC: CA22000D 0A081485
	v_or3_b32 v6, v8, v6, v7                                   // 000000001AC4: D6580006 041E0D08
	v_lshlrev_b32_e32 v7, 6, v11                               // 000000001ACC: 300E1686
	s_waitcnt lgkmcnt(0)                                       // 000000001AD0: BF89FC07
	v_lshlrev_b32_e32 v8, 7, v22                               // 000000001AD4: 30102C87
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001AD8: BF870123
	v_or3_b32 v6, v9, v21, v6                                  // 000000001ADC: D6580006 041A2B09
	v_or_b32_e32 v9, s2, v0                                    // 000000001AE4: 38120002
	v_or3_b32 v8, v6, v7, v8                                   // 000000001AE8: D6580008 04220F06
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001AF0: BF870092
	v_add_co_u32 v6, s2, s10, v9                               // 000000001AF4: D7000206 0002120A
	v_add_co_ci_u32_e64 v7, s2, s11, v10, s2                   // 000000001AFC: D5200207 000A140B
	global_store_b8 v[6:7], v8, off                            // 000000001B04: DC620000 007C0806
	s_or_b32 exec_lo, exec_lo, s7                              // 000000001B0C: 8C7E077E
	s_and_saveexec_b32 s2, s3                                  // 000000001B10: BE822003
	s_cbranch_execz 30                                         // 000000001B14: BFA5001E <attn_prep_24_4_256_64_8204_11_k4jv4+0x1b90>
	v_cndmask_b32_e64 v6, v18, v20, s5                         // 000000001B18: D5010006 00162912
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)// 000000001B20: BF8704A1
	v_cndmask_b32_e64 v6, v6, v19, s6                          // 000000001B24: D5010006 001A2706
	s_lshl_b32 s6, s8, 1                                       // 000000001B2C: 84068108
	s_ashr_i32 s7, s6, 31                                      // 000000001B30: 86079F06
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001B34: BF870099
	s_lshl_b64 s[6:7], s[6:7], 2                               // 000000001B38: 84868206
	v_mul_f32_e32 v7, 0x37800000, v6                           // 000000001B3C: 100E0CFF 37800000
	s_add_u32 s6, s10, s6                                      // 000000001B44: 8006060A
	s_addc_u32 s7, s11, s7                                     // 000000001B48: 8207070B
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001B4C: BF870121
	v_dual_cndmask_b32 v6, v6, v7 :: v_dual_mov_b32 v7, 0x140000// 000000001B50: CA500F06 060600FF 00140000
	v_cmp_class_f32_e64 vcc_lo, v17, 0x260                     // 000000001B5C: D47E006A 0001FF11 00000260
	v_cndmask_b32_e32 v6, v6, v17, vcc_lo                      // 000000001B68: 020C2306
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001B6C: BF870091
	v_mul_f32_e32 v6, 0x3d800000, v6                           // 000000001B70: 100C0CFF 3D800000
	v_mul_f32_e32 v6, v15, v6                                  // 000000001B78: 100C0D0F
	s_delay_alu instid0(VALU_DEP_1)                            // 000000001B7C: BF870001
	v_mul_f32_e32 v6, 0x3ba06c99, v6                           // 000000001B80: 100C0CFF 3BA06C99
	global_store_b32 v7, v6, s[6:7] offset:1924                // 000000001B88: DC6A0784 00060607
	s_or_b32 exec_lo, exec_lo, s2                              // 000000001B90: 8C7E027E
	s_waitcnt_vscnt null, 0x0                                  // 000000001B94: BC7C0000
	s_barrier                                                  // 000000001B98: BFBD0000
	buffer_gl0_inv                                             // 000000001B9C: E0AC0000 00000000
	ds_load_b32 v6, v3 offset:13312                            // 000000001BA4: D8D83400 06000003
	s_waitcnt lgkmcnt(0)                                       // 000000001BAC: BF89FC07
	v_mul_f32_e32 v7, v6, v6                                   // 000000001BB0: 100E0D06
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001BB4: BF870091
	v_mov_b32_dpp v7, v7 row_shr:1 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001BB8: 7E0E02FA FF091107
	v_fmac_f32_e32 v7, v6, v6                                  // 000000001BC0: 560E0D06
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001BC4: BF870091
	v_add_f32_dpp v6, v7, v7 row_shr:2 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001BC8: 060C0EFA FF091207
	v_add_f32_dpp v6, v6, v6 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001BD0: 060C0CFA FF091406
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001BD8: BF870091
	v_add_f32_dpp v6, v6, v6 row_shr:8 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001BDC: 060C0CFA FF091806
	v_readlane_b32 s5, v6, 15                                  // 000000001BE4: D7600005 00011F06
	v_readlane_b32 s6, v6, 31                                  // 000000001BEC: D7600006 00013F06
	s_and_saveexec_b32 s2, s1                                  // 000000001BF4: BE822001
	s_delay_alu instid0(VALU_DEP_1)                            // 000000001BF8: BF870001
	v_add_f32_e64 v6, s5, s6                                   // 000000001BFC: D5030006 00000C05
	ds_store_b32 v13, v6 offset:18048                          // 000000001C04: D8344680 0000060D
	s_or_b32 exec_lo, exec_lo, s2                              // 000000001C0C: 8C7E027E
	v_mov_b32_e32 v23, 0                                       // 000000001C10: 7E2E0280
	s_waitcnt lgkmcnt(0)                                       // 000000001C14: BF89FC07
	s_barrier                                                  // 000000001C18: BFBD0000
	buffer_gl0_inv                                             // 000000001C1C: E0AC0000 00000000
	ds_load_b128 v[6:9], v23 offset:18048                      // 000000001C24: DBFC4680 06000017
	ds_load_b128 v[10:13], v23 offset:18064                    // 000000001C2C: DBFC4690 0A000017
	ds_load_b128 v[15:18], v23 offset:18032                    // 000000001C34: DBFC4670 0F000017
	s_waitcnt lgkmcnt(2)                                       // 000000001C3C: BF89FC27
	v_add_f32_e32 v6, v6, v7                                   // 000000001C40: 060C0F06
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001C44: BF870091
	v_add_f32_e32 v6, v8, v6                                   // 000000001C48: 060C0D08
	v_add_f32_e32 v6, v9, v6                                   // 000000001C4C: 060C0D09
	s_waitcnt lgkmcnt(1)                                       // 000000001C50: BF89FC17
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001C54: BF870091
	v_add_f32_e32 v6, v10, v6                                  // 000000001C58: 060C0D0A
	v_add_f32_e32 v6, v11, v6                                  // 000000001C5C: 060C0D0B
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001C60: BF870091
	v_add_f32_e32 v6, v12, v6                                  // 000000001C64: 060C0D0C
	v_add_f32_e32 v11, v13, v6                                 // 000000001C68: 06160D0D
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001C6C: BF870121
	v_mul_f32_e32 v6, 0x4f800000, v11                          // 000000001C70: 100C16FF 4F800000
	v_cmp_gt_f32_e32 vcc_lo, 0xf800000, v11                    // 000000001C78: 7C2816FF 0F800000
	v_cndmask_b32_e32 v6, v11, v6, vcc_lo                      // 000000001C80: 020C0D0B
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)// 000000001C84: BF870141
	v_sqrt_f32_e32 v7, v6                                      // 000000001C88: 7E0E6706
	s_waitcnt_depctr 0xfff                                     // 000000001C8C: BF880FFF
	v_add_nc_u32_e32 v8, -1, v7                                // 000000001C90: 4A100EC1
	v_add_nc_u32_e32 v9, 1, v7                                 // 000000001C94: 4A120E81
	v_fma_f32 v10, -v8, v7, v6                                 // 000000001C98: D613000A 241A0F08
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001CA0: BF870112
	v_fma_f32 v12, -v9, v7, v6                                 // 000000001CA4: D613000C 241A0F09
	v_cmp_ge_f32_e64 s2, 0, v10                                // 000000001CAC: D4160002 00021480
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000001CB4: BF870191
	v_cndmask_b32_e64 v7, v7, v8, s2                           // 000000001CB8: D5010007 000A1107
	v_cmp_lt_f32_e64 s2, 0, v12                                // 000000001CC0: D4110002 00021880
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001CC8: BF870091
	v_cndmask_b32_e64 v7, v7, v9, s2                           // 000000001CCC: D5010007 000A1307
	v_mul_f32_e32 v8, 0x37800000, v7                           // 000000001CD4: 10100EFF 37800000
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001CDC: BF870121
	v_cndmask_b32_e32 v7, v7, v8, vcc_lo                       // 000000001CE0: 020E1107
	v_cmp_class_f32_e64 vcc_lo, v6, 0x260                      // 000000001CE4: D47E006A 0001FF06 00000260
	v_cndmask_b32_e32 v6, v7, v6, vcc_lo                       // 000000001CF0: 020C0D07
	ds_load_b128 v[7:10], v23 offset:17984                     // 000000001CF4: DBFC4640 07000017
	ds_load_b128 v[19:22], v23 offset:18000                    // 000000001CFC: DBFC4650 13000017
	ds_load_b128 v[23:26], v23 offset:18016                    // 000000001D04: DBFC4660 17000017
	ds_load_b32 v3, v3 offset:13312                            // 000000001D0C: D8D83400 03000003
	s_waitcnt lgkmcnt(3)                                       // 000000001D14: BF89FC37
	v_add_f32_e32 v7, v8, v7                                   // 000000001D18: 060E0F08
	v_add_f32_e32 v8, v8, v9                                   // 000000001D1C: 06101308
	v_add_f32_e32 v9, v10, v9                                  // 000000001D20: 0612130A
	s_waitcnt lgkmcnt(2)                                       // 000000001D24: BF89FC27
	v_add_f32_e32 v10, v10, v19                                // 000000001D28: 0614270A
	v_add_f32_e32 v19, v20, v19                                // 000000001D2C: 06262714
	v_div_scale_f32 v12, null, v6, v6, 0x41800000              // 000000001D30: D6FC7C0C 03FE0D06 41800000
	v_div_scale_f32 v28, vcc_lo, 0x41800000, v6, 0x41800000    // 000000001D3C: D6FC6A1C 03FE0CFF 41800000
	v_add_f32_e32 v20, v20, v21                                // 000000001D48: 06282B14
	s_delay_alu instid0(VALU_DEP_3)                            // 000000001D4C: BF870003
	v_rcp_f32_e32 v13, v12                                     // 000000001D50: 7E1A550C
	v_add_f32_e32 v21, v22, v21                                // 000000001D54: 062A2B16
	s_waitcnt lgkmcnt(1)                                       // 000000001D58: BF89FC17
	v_dual_add_f32 v22, v22, v23 :: v_dual_mul_f32 v9, 0.5, v9 // 000000001D5C: C9062F16 160812F0
	v_add_f32_e32 v23, v24, v23                                // 000000001D64: 062E2F18
	v_dual_mul_f32 v7, 0.5, v7 :: v_dual_mul_f32 v8, 0.5, v8   // 000000001D68: C8C60EF0 070810F0
	s_waitcnt_depctr 0xfff                                     // 000000001D70: BF880FFF
	v_fma_f32 v27, -v12, v13, 1.0                              // 000000001D74: D613001B 23CA1B0C
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D7C: BF870091
	v_fmac_f32_e32 v13, v27, v13                               // 000000001D80: 561A1B1B
	v_mul_f32_e32 v27, v28, v13                                // 000000001D84: 10361B1C
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D88: BF870091
	v_fma_f32 v29, -v12, v27, v28                              // 000000001D8C: D613001D 2472370C
	v_fmac_f32_e32 v27, v29, v13                               // 000000001D94: 56361B1D
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D98: BF870091
	v_fma_f32 v12, -v12, v27, v28                              // 000000001D9C: D613000C 2472370C
	v_div_fmas_f32 v12, v12, v13, v27                          // 000000001DA4: D637000C 046E1B0C
	v_cmp_lt_f32_e32 vcc_lo, 0, v11                            // 000000001DAC: 7C221680
	v_dual_add_f32 v13, v16, v17 :: v_dual_mul_f32 v10, 0.5, v10// 000000001DB0: C9062310 0D0A14F0
	s_delay_alu instid0(VALU_DEP_3)                            // 000000001DB8: BF870003
	v_div_fixup_f32 v12, v12, v6, 0x41800000                   // 000000001DBC: D627000C 03FE0D0C 41800000
	v_add_f32_e32 v24, v24, v25                                // 000000001DC8: 06303318
	v_add_f32_e32 v25, v26, v25                                // 000000001DCC: 0632331A
	v_add_f32_e32 v26, v26, v15                                // 000000001DD0: 06341F1A
	v_add_f32_e32 v15, v16, v15                                // 000000001DD4: 061E1F10
	v_dual_cndmask_b32 v11, 0, v12 :: v_dual_add_f32 v16, v18, v17// 000000001DD8: CA481880 0B102312
	v_dual_mul_f32 v17, 0.5, v19 :: v_dual_mul_f32 v12, 0.5, v20// 000000001DE0: C8C626F0 110C28F0
	v_mul_f32_e32 v19, 0.5, v22                                // 000000001DE8: 10262CF0
	s_waitcnt lgkmcnt(0)                                       // 000000001DEC: BF89FC07
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)// 000000001DF0: BF8701B3
	v_dual_mul_f32 v3, v3, v11 :: v_dual_mul_f32 v18, 0.5, v21 // 000000001DF4: C8C61703 03122AF0
	v_dual_mul_f32 v11, 0.5, v24 :: v_dual_mul_f32 v20, 0.5, v23// 000000001DFC: C8C630F0 0B142EF0
	v_mul_f32_e32 v21, 0.5, v25                                // 000000001E04: 102A32F0
	v_cmp_gt_f32_e32 vcc_lo, v3, v7                            // 000000001E08: 7C280F03
	v_dual_mul_f32 v22, 0.5, v26 :: v_dual_mul_f32 v15, 0.5, v15// 000000001E0C: C8C634F0 160E1EF0
	v_cndmask_b32_e64 v7, 0, 1, vcc_lo                         // 000000001E14: D5010007 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v8                            // 000000001E1C: 7C281103
	v_cndmask_b32_e64 v8, 0, 1, vcc_lo                         // 000000001E20: D5010008 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v10                           // 000000001E28: 7C281503
	v_cndmask_b32_e64 v10, 0, 1, vcc_lo                        // 000000001E2C: D501000A 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v9                            // 000000001E34: 7C281303
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)// 000000001E38: BF870244
	v_add_co_ci_u32_e32 v7, vcc_lo, v7, v8, vcc_lo             // 000000001E3C: 400E1107
	v_cmp_gt_f32_e32 vcc_lo, v3, v12                           // 000000001E40: 7C281903
	v_cndmask_b32_e64 v8, 0, 1, vcc_lo                         // 000000001E44: D5010008 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v17                           // 000000001E4C: 7C282303
	v_add_co_ci_u32_e32 v7, vcc_lo, v7, v10, vcc_lo            // 000000001E50: 400E1507
	v_cmp_gt_f32_e32 vcc_lo, v3, v19                           // 000000001E54: 7C282703
	v_mul_f32_e32 v10, 0.5, v16                                // 000000001E58: 101420F0
	v_cndmask_b32_e64 v9, 0, 1, vcc_lo                         // 000000001E5C: D5010009 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v18                           // 000000001E64: 7C282503
	v_add_co_ci_u32_e32 v7, vcc_lo, v7, v8, vcc_lo             // 000000001E68: 400E1107
	v_cmp_gt_f32_e32 vcc_lo, v3, v11                           // 000000001E6C: 7C281703
	v_cndmask_b32_e64 v8, 0, 1, vcc_lo                         // 000000001E70: D5010008 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v20                           // 000000001E78: 7C282903
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)// 000000001E7C: BF870244
	v_add_co_ci_u32_e32 v7, vcc_lo, v7, v9, vcc_lo             // 000000001E80: 400E1307
	v_cmp_gt_f32_e32 vcc_lo, v3, v22                           // 000000001E84: 7C282D03
	v_cndmask_b32_e64 v9, 0, 1, vcc_lo                         // 000000001E88: D5010009 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v21                           // 000000001E90: 7C282B03
	v_add_co_ci_u32_e32 v7, vcc_lo, v7, v8, vcc_lo             // 000000001E94: 400E1107
	v_cmp_gt_f32_e32 vcc_lo, v3, v15                           // 000000001E98: 7C281F03
	v_mul_f32_e32 v8, 0.5, v13                                 // 000000001E9C: 10101AF0
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001EA0: BF870113
	v_add_co_ci_u32_e32 v7, vcc_lo, v7, v9, vcc_lo             // 000000001EA4: 400E1307
	v_cmp_gt_f32_e32 vcc_lo, v3, v8                            // 000000001EA8: 7C281103
	v_cndmask_b32_e64 v8, 0, 1, vcc_lo                         // 000000001EAC: D5010008 01A90280
	v_cmp_gt_f32_e32 vcc_lo, v3, v10                           // 000000001EB4: 7C281503
	s_delay_alu instid0(VALU_DEP_2)                            // 000000001EB8: BF870002
	v_add_co_ci_u32_e32 v3, vcc_lo, v7, v8, vcc_lo             // 000000001EBC: 40061107
	ds_store_b32 v14, v3                                       // 000000001EC0: D8340000 0000030E
	s_and_saveexec_b32 s2, s3                                  // 000000001EC8: BE822003
	s_cbranch_execz 9                                          // 000000001ECC: BFA50009 <attn_prep_24_4_256_64_8204_11_k4jv4+0x1ef4>
	v_mul_f32_e32 v3, 0x3d800000, v6                           // 000000001ED0: 10060CFF 3D800000
	s_lshl_b64 s[6:7], s[8:9], 2                               // 000000001ED8: 84868208
	v_mov_b32_e32 v6, 0x250000                                 // 000000001EDC: 7E0C02FF 00250000
	s_add_u32 s6, s10, s6                                      // 000000001EE4: 8006060A
	s_addc_u32 s7, s11, s7                                     // 000000001EE8: 8207070B
	global_store_b32 v6, v3, s[6:7] offset:3552                // 000000001EEC: DC6A0DE0 00060306
	s_or_b32 exec_lo, exec_lo, s2                              // 000000001EF4: 8C7E027E
	s_waitcnt lgkmcnt(0)                                       // 000000001EF8: BF89FC07
	s_waitcnt_vscnt null, 0x0                                  // 000000001EFC: BC7C0000
	s_barrier                                                  // 000000001F00: BFBD0000
	buffer_gl0_inv                                             // 000000001F04: E0AC0000 00000000
	s_and_saveexec_b32 s2, s4                                  // 000000001F0C: BE822004
	s_cbranch_execz 21                                         // 000000001F10: BFA50015 <attn_prep_24_4_256_64_8204_11_k4jv4+0x1f68>
	v_lshlrev_b32_e32 v3, 2, v5                                // 000000001F14: 30060A82
	s_lshl_b64 s[4:5], s[8:9], 7                               // 000000001F18: 84848708
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)// 000000001F1C: BF8700C9
	s_add_u32 s3, s10, s4                                      // 000000001F20: 8003040A
	s_addc_u32 s4, s11, s5                                     // 000000001F24: 8204050B
	ds_load_b64 v[5:6], v3 offset:16896                        // 000000001F28: D9D84200 05000003
	v_add_co_u32 v0, s3, s3, v0                                // 000000001F30: D7000300 00020003
	v_add_co_ci_u32_e64 v3, null, s4, 0, s3                    // 000000001F38: D5207C03 000D0004
	s_waitcnt lgkmcnt(0)                                       // 000000001F40: BF89FC07
	v_lshl_or_b32 v7, v6, 4, v5                                // 000000001F44: D6560007 04150906
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000001F4C: BF870193
	v_add_co_u32 v5, vcc_lo, 0x150000, v0                      // 000000001F50: D7006A05 000200FF 00150000
	v_add_co_ci_u32_e32 v6, vcc_lo, 0, v3, vcc_lo              // 000000001F5C: 400C0680
	global_store_b8 v[5:6], v7, off offset:2016                // 000000001F60: DC6207E0 007C0705
	s_or_b32 exec_lo, exec_lo, s2                              // 000000001F68: 8C7E027E
	s_waitcnt_vscnt null, 0x0                                  // 000000001F6C: BC7C0000
	s_barrier                                                  // 000000001F70: BFBD0000
	buffer_gl0_inv                                             // 000000001F74: E0AC0000 00000000
	s_and_saveexec_b32 s2, s0                                  // 000000001F7C: BE822000
	s_cbranch_execz 357                                        // 000000001F80: BFA50165 <attn_prep_24_4_256_64_8204_11_k4jv4+0x2518>
	v_lshl_or_b32 v6, v1, 10, v2                               // 000000001F84: D6560006 04091501
	ds_load_b128 v[8:11], v6                                   // 000000001F8C: DBFC0000 08000006
	ds_load_b128 v[12:15], v6 offset:16                        // 000000001F94: DBFC0010 0C000006
	s_waitcnt lgkmcnt(1)                                       // 000000001F9C: BF89FC17
	v_max3_f32 v0, |v8|, 0, |v9|                               // 000000001FA0: D61C0500 04250108
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)// 000000001FA8: BF8700A1
	v_max3_f32 v0, v0, |v10|, |v11|                            // 000000001FAC: D61C0600 042E1500
	s_waitcnt lgkmcnt(0)                                       // 000000001FB4: BF89FC07
	v_max3_f32 v0, v0, |v12|, |v13|                            // 000000001FB8: D61C0600 04361900
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001FC0: BF870091
	v_max3_f32 v0, v0, |v14|, |v15|                            // 000000001FC4: D61C0600 043E1D00
	v_mov_b32_dpp v2, v0 row_shr:1 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001FCC: 7E0402FA FF091100
	...
	v_max_f32_e32 v0, v0, v2                                   // 000000001FDC: 20000500
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001FE0: BF870091
	v_mov_b32_dpp v2, v0 row_shr:2 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001FE4: 7E0402FA FF091200
	v_max_f32_e32 v2, v2, v2                                   // 000000001FEC: 20040502
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001FF0: BF870091
	v_max_f32_e32 v0, v0, v2                                   // 000000001FF4: 20000500
	v_mov_b32_dpp v2, v0 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000001FF8: 7E0402FA FF091400
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002000: BF870091
	v_max_f32_e32 v2, v2, v2                                   // 000000002004: 20040502
	v_max_f32_e32 v0, v0, v2                                   // 000000002008: 20000500
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 00000000200C: BF870091
	v_mov_b32_dpp v2, v0 row_shr:8 row_mask:0xf bank_mask:0xf bound_ctrl:1// 000000002010: 7E0402FA FF091800
	v_max_f32_e32 v2, v2, v2                                   // 000000002018: 20040502
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 00000000201C: BF870091
	v_max_f32_e32 v0, v0, v2                                   // 000000002020: 20000500
	v_readlane_b32 s0, v0, 31                                  // 000000002024: D7600000 00013F00
	v_readlane_b32 s2, v0, 15                                  // 00000000202C: D7600002 00011F00
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000002034: BF870112
	v_max_f32_e64 v0, s0, s0                                   // 000000002038: D5100000 00000000
	v_max_f32_e64 v2, s2, s2                                   // 000000002040: D5100002 00000402
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002048: BF870091
	v_max_f32_e32 v0, v2, v0                                   // 00000000204C: 20000102
	v_div_scale_f32 v2, null, 0x42fe0000, 0x42fe0000, v0       // 000000002050: D6FC7C02 0401FEFF 42FE0000
	v_div_scale_f32 v7, vcc_lo, v0, 0x42fe0000, v0             // 00000000205C: D6FC6A07 0401FF00 42FE0000
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)// 000000002068: BF8700B2
	v_rcp_f32_e32 v3, v2                                       // 00000000206C: 7E065502
	s_waitcnt_depctr 0xfff                                     // 000000002070: BF880FFF
	v_fma_f32 v5, -v2, v3, 1.0                                 // 000000002074: D6130005 23CA0702
	v_fmac_f32_e32 v3, v5, v3                                  // 00000000207C: 56060705
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002080: BF870091
	v_mul_f32_e32 v5, v7, v3                                   // 000000002084: 100A0707
	v_fma_f32 v16, -v2, v5, v7                                 // 000000002088: D6130010 241E0B02
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002090: BF870091
	v_fmac_f32_e32 v5, v16, v3                                 // 000000002094: 560A0710
	v_fma_f32 v2, -v2, v5, v7                                  // 000000002098: D6130002 241E0B02
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000020A0: BF870091
	v_div_fmas_f32 v2, v2, v3, v5                              // 0000000020A4: D6370002 04160702
	v_div_fixup_f32 v7, v2, 0x42fe0000, v0                     // 0000000020AC: D6270007 0401FF02 42FE0000
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 0000000020B8: BF870121
	v_div_scale_f32 v0, null, v7, v7, 1.0                      // 0000000020BC: D6FC7C00 03CA0F07
	v_div_scale_f32 v16, vcc_lo, 1.0, v7, 1.0                  // 0000000020C4: D6FC6A10 03CA0EF2
	v_rcp_f32_e32 v5, v0                                       // 0000000020CC: 7E0A5500
	s_waitcnt_depctr 0xfff                                     // 0000000020D0: BF880FFF
	v_fma_f32 v2, -v0, v5, 1.0                                 // 0000000020D4: D6130002 23CA0B00
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 0000000020DC: BF870121
	v_fmac_f32_e32 v5, v2, v5                                  // 0000000020E0: 560A0B02
	v_mad_u64_u32 v[2:3], null, s28, 6, v[1:2]                 // 0000000020E4: D6FE7C02 04050C1C
	v_dual_mov_b32 v3, 0 :: v_dual_mul_f32 v18, v16, v5        // 0000000020EC: CA060080 03120B10
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000020F4: BF870091
	v_fma_f32 v17, -v0, v18, v16                               // 0000000020F8: D6130011 24422500
	v_fmac_f32_e32 v18, v17, v5                                // 000000002100: 56240B11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)// 000000002104: BF870211
	v_fma_f32 v0, -v0, v18, v16                                // 000000002108: D6130000 24422500
	v_mad_u64_u32 v[16:17], null, s12, 24, v[2:3]              // 000000002110: D6FE7C10 0409300C
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)// 000000002118: BF8701A2
	v_div_fmas_f32 v0, v0, v5, v18                             // 00000000211C: D6370000 044A0B00
	v_cmp_neq_f32_e32 vcc_lo, 0, v7                            // 000000002124: 7C3A0E80
	v_lshlrev_b64 v[2:3], 8, v[16:17]                          // 000000002128: D73C0002 00022088
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000002130: BF870123
	v_div_fixup_f32 v5, v0, v7, 1.0                            // 000000002134: D6270005 03CA0F00
	v_lshlrev_b32_e32 v0, 3, v4                                // 00000000213C: 30000883
	v_cndmask_b32_e32 v4, 0, v5, vcc_lo                        // 000000002140: 02080A80
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)// 000000002144: BF8701A4
	v_add_co_u32 v5, vcc_lo, s16, v2                           // 000000002148: D7006A05 00020410
	v_add_co_ci_u32_e32 v18, vcc_lo, s17, v3, vcc_lo           // 000000002150: 40240611
	v_mul_f32_e32 v13, v13, v4                                 // 000000002154: 101A090D
	v_mul_f32_e32 v9, v9, v4                                   // 000000002158: 10120909
	v_mul_f32_e32 v10, v10, v4                                 // 00000000215C: 1014090A
	v_mul_f32_e32 v14, v14, v4                                 // 000000002160: 101C090E
	v_mul_f32_e32 v11, v11, v4                                 // 000000002164: 1016090B
	v_rndne_f32_e32 v13, v13                                   // 000000002168: 7E1A470D
	v_rndne_f32_e32 v9, v9                                     // 00000000216C: 7E124709
	v_rndne_f32_e32 v10, v10                                   // 000000002170: 7E14470A
	v_rndne_f32_e32 v14, v14                                   // 000000002174: 7E1C470E
	v_rndne_f32_e32 v11, v11                                   // 000000002178: 7E16470B
	v_cvt_i32_f32_e32 v13, v13                                 // 00000000217C: 7E1A110D
	v_mul_f32_e32 v8, v8, v4                                   // 000000002180: 10100908
	v_cvt_i32_f32_e32 v9, v9                                   // 000000002184: 7E121109
	v_cvt_i32_f32_e32 v10, v10                                 // 000000002188: 7E14110A
	v_cvt_i32_f32_e32 v14, v14                                 // 00000000218C: 7E1C110E
	v_dual_mul_f32 v12, v12, v4 :: v_dual_lshlrev_b32 v13, 8, v13// 000000002190: C8E2090C 0C0C1A88
	v_mul_f32_e32 v4, v15, v4                                  // 000000002198: 1008090F
	v_rndne_f32_e32 v8, v8                                     // 00000000219C: 7E104708
	v_cvt_i32_f32_e32 v11, v11                                 // 0000000021A0: 7E16110B
	s_delay_alu instid0(VALU_DEP_4)                            // 0000000021A4: BF870004
	v_and_b32_e32 v13, 0xff00, v13                             // 0000000021A8: 361A1AFF 0000FF00
	v_rndne_f32_e32 v12, v12                                   // 0000000021B0: 7E18470C
	v_rndne_f32_e32 v4, v4                                     // 0000000021B4: 7E084704
	v_cvt_i32_f32_e32 v8, v8                                   // 0000000021B8: 7E101108
	v_lshlrev_b32_e32 v9, 8, v9                                // 0000000021BC: 30121288
	v_lshlrev_b32_e32 v10, 16, v10                             // 0000000021C0: 30141490
	v_cvt_i32_f32_e32 v12, v12                                 // 0000000021C4: 7E18110C
	v_cvt_i32_f32_e32 v4, v4                                   // 0000000021C8: 7E081104
	v_lshlrev_b32_e32 v14, 16, v14                             // 0000000021CC: 301C1C90
	v_perm_b32 v11, v11, v8, 0x40c0c00                         // 0000000021D0: D644000B 03FE110B 040C0C00
	v_and_b32_e32 v10, 0xff0000, v10                           // 0000000021DC: 361414FF 00FF0000
	v_add_co_u32 v8, vcc_lo, v5, v0                            // 0000000021E4: D7006A08 00020105
	v_perm_b32 v4, v4, v12, 0x40c0c00                          // 0000000021EC: D6440004 03FE1904 040C0C00
	v_and_b32_e32 v12, 0xff00, v9                              // 0000000021F8: 361812FF 0000FF00
	v_and_b32_e32 v14, 0xff0000, v14                           // 000000002200: 361C1CFF 00FF0000
	v_add_co_ci_u32_e32 v9, vcc_lo, 0, v18, vcc_lo             // 000000002208: 40122480
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 00000000220C: BF870193
	v_or3_b32 v10, v11, v12, v10                               // 000000002210: D658000A 042A190B
	v_or3_b32 v11, v4, v13, v14                                // 000000002218: D658000B 043A1B04
	v_lshlrev_b64 v[4:5], 2, v[16:17]                          // 000000002220: D73C0004 00022082
	global_store_b64 v[8:9], v[10:11], off                     // 000000002228: DC6E0000 007C0A08
	s_and_saveexec_b32 s0, s1                                  // 000000002230: BE802001
	s_cbranch_execz 5                                          // 000000002234: BFA50005 <attn_prep_24_4_256_64_8204_11_k4jv4+0x224c>
	v_add_co_u32 v8, vcc_lo, s18, v4                           // 000000002238: D7006A08 00020812
	v_add_co_ci_u32_e32 v9, vcc_lo, s19, v5, vcc_lo            // 000000002240: 40120A13
	global_store_b32 v[8:9], v7, off                           // 000000002244: DC6A0000 007C0708
	s_or_b32 exec_lo, exec_lo, s0                              // 00000000224C: 8C7E007E
	v_lshlrev_b32_e32 v10, 2, v0                               // 000000002250: 30140082
	ds_load_b128 v[6:9], v6 offset:6144                        // 000000002254: DBFC1800 06000006
	v_lshl_or_b32 v1, v1, 10, v10                              // 00000000225C: D6560001 04291501
	ds_load_b128 v[10:13], v1 offset:6160                      // 000000002264: DBFC1810 0A000001
	s_waitcnt lgkmcnt(1)                                       // 00000000226C: BF89FC17
	v_max3_f32 v1, |v6|, 0, |v7|                               // 000000002270: D61C0501 041D0106
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)// 000000002278: BF8700A1
	v_max3_f32 v1, v1, |v8|, |v9|                              // 00000000227C: D61C0601 04261101
	s_waitcnt lgkmcnt(0)                                       // 000000002284: BF89FC07
	v_max3_f32 v1, v1, |v10|, |v11|                            // 000000002288: D61C0601 042E1501
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002290: BF870091
	v_max3_f32 v1, v1, |v12|, |v13|                            // 000000002294: D61C0601 04361901
	v_mov_b32_dpp v14, v1 row_shr:1 row_mask:0xf bank_mask:0xf bound_ctrl:1// 00000000229C: 7E1C02FA FF091101
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000022A4: BF870091
	v_max_f32_e32 v14, v14, v14                                // 0000000022A8: 201C1D0E
	v_max_f32_e32 v1, v1, v14                                  // 0000000022AC: 20021D01
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000022B0: BF870091
	v_mov_b32_dpp v14, v1 row_shr:2 row_mask:0xf bank_mask:0xf bound_ctrl:1// 0000000022B4: 7E1C02FA FF091201
	v_max_f32_e32 v14, v14, v14                                // 0000000022BC: 201C1D0E
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000022C0: BF870091
	v_max_f32_e32 v1, v1, v14                                  // 0000000022C4: 20021D01
	v_mov_b32_dpp v14, v1 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1// 0000000022C8: 7E1C02FA FF091401
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000022D0: BF870091
	v_max_f32_e32 v14, v14, v14                                // 0000000022D4: 201C1D0E
	v_max_f32_e32 v1, v1, v14                                  // 0000000022D8: 20021D01
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000022DC: BF870091
	v_mov_b32_dpp v14, v1 row_shr:8 row_mask:0xf bank_mask:0xf bound_ctrl:1// 0000000022E0: 7E1C02FA FF091801
	v_max_f32_e32 v14, v14, v14                                // 0000000022E8: 201C1D0E
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000022EC: BF870091
	v_max_f32_e32 v1, v1, v14                                  // 0000000022F0: 20021D01
	v_readlane_b32 s0, v1, 31                                  // 0000000022F4: D7600000 00013F01
	v_readlane_b32 s2, v1, 15                                  // 0000000022FC: D7600002 00011F01
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000002304: BF870112
	v_max_f32_e64 v1, s0, s0                                   // 000000002308: D5100001 00000000
	v_max_f32_e64 v14, s2, s2                                  // 000000002310: D510000E 00000402
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002318: BF870091
	v_max_f32_e32 v1, v14, v1                                  // 00000000231C: 2002030E
	v_div_scale_f32 v14, null, 0x42fe0000, 0x42fe0000, v1      // 000000002320: D6FC7C0E 0405FEFF 42FE0000
	v_div_scale_f32 v17, vcc_lo, v1, 0x42fe0000, v1            // 00000000232C: D6FC6A11 0405FF01 42FE0000
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)// 000000002338: BF8700B2
	v_rcp_f32_e32 v15, v14                                     // 00000000233C: 7E1E550E
	s_waitcnt_depctr 0xfff                                     // 000000002340: BF880FFF
	v_fma_f32 v16, -v14, v15, 1.0                              // 000000002344: D6130010 23CA1F0E
	v_fmac_f32_e32 v15, v16, v15                               // 00000000234C: 561E1F10
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002350: BF870091
	v_mul_f32_e32 v16, v17, v15                                // 000000002354: 10201F11
	v_fma_f32 v18, -v14, v16, v17                              // 000000002358: D6130012 2446210E
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002360: BF870091
	v_fmac_f32_e32 v16, v18, v15                               // 000000002364: 56201F12
	v_fma_f32 v14, -v14, v16, v17                              // 000000002368: D613000E 2446210E
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002370: BF870091
	v_div_fmas_f32 v14, v14, v15, v16                          // 000000002374: D637000E 04421F0E
	v_div_fixup_f32 v1, v14, 0x42fe0000, v1                    // 00000000237C: D6270001 0405FF0E 42FE0000
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000002388: BF870121
	v_div_scale_f32 v14, null, v1, v1, 1.0                     // 00000000238C: D6FC7C0E 03CA0301
	v_div_scale_f32 v17, vcc_lo, 1.0, v1, 1.0                  // 000000002394: D6FC6A11 03CA02F2
	v_rcp_f32_e32 v15, v14                                     // 00000000239C: 7E1E550E
	s_waitcnt_depctr 0xfff                                     // 0000000023A0: BF880FFF
	v_fma_f32 v16, -v14, v15, 1.0                              // 0000000023A4: D6130010 23CA1F0E
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000023AC: BF870091
	v_fmac_f32_e32 v15, v16, v15                               // 0000000023B0: 561E1F10
	v_mul_f32_e32 v16, v17, v15                                // 0000000023B4: 10201F11
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000023B8: BF870091
	v_fma_f32 v18, -v14, v16, v17                              // 0000000023BC: D6130012 2446210E
	v_fmac_f32_e32 v16, v18, v15                               // 0000000023C4: 56201F12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000023C8: BF870091
	v_fma_f32 v14, -v14, v16, v17                              // 0000000023CC: D613000E 2446210E
	v_div_fmas_f32 v14, v14, v15, v16                          // 0000000023D4: D637000E 04421F0E
	v_cmp_neq_f32_e32 vcc_lo, 0, v1                            // 0000000023DC: 7C3A0280
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000023E0: BF870092
	v_div_fixup_f32 v14, v14, v1, 1.0                          // 0000000023E4: D627000E 03CA030E
	v_cndmask_b32_e32 v14, 0, v14, vcc_lo                      // 0000000023EC: 021C1C80
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000023F0: BF870091
	v_mul_f32_e32 v7, v7, v14                                  // 0000000023F4: 100E1D07
	v_rndne_f32_e32 v7, v7                                     // 0000000023F8: 7E0E4707
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000023FC: BF870091
	v_cvt_i32_f32_e32 v7, v7                                   // 000000002400: 7E0E1107
	v_lshlrev_b32_e32 v7, 8, v7                                // 000000002404: 300E0E88
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)// 000000002408: BF8701B1
	v_dual_mul_f32 v12, v12, v14 :: v_dual_and_b32 v7, 0xff00, v7// 00000000240C: C8E41D0C 0C060EFF 0000FF00
	v_mul_f32_e32 v8, v8, v14                                  // 000000002418: 10101D08
	v_mul_f32_e32 v10, v10, v14                                // 00000000241C: 10141D0A
	v_rndne_f32_e32 v12, v12                                   // 000000002420: 7E18470C
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000002424: BF870193
	v_rndne_f32_e32 v8, v8                                     // 000000002428: 7E104708
	v_rndne_f32_e32 v10, v10                                   // 00000000242C: 7E14470A
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)// 000000002430: BF870223
	v_cvt_i32_f32_e32 v12, v12                                 // 000000002434: 7E18110C
	v_mul_f32_e32 v11, v11, v14                                // 000000002438: 10161D0B
	v_cvt_i32_f32_e32 v8, v8                                   // 00000000243C: 7E101108
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)// 000000002440: BF870214
	v_cvt_i32_f32_e32 v10, v10                                 // 000000002444: 7E14110A
	v_lshlrev_b32_e32 v12, 16, v12                             // 000000002448: 30181890
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)// 00000000244C: BF8701B4
	v_rndne_f32_e32 v11, v11                                   // 000000002450: 7E16470B
	v_mul_f32_e32 v6, v6, v14                                  // 000000002454: 100C1D06
	v_dual_mul_f32 v13, v13, v14 :: v_dual_lshlrev_b32 v8, 16, v8// 000000002458: C8E21D0D 0D081090
	v_cvt_i32_f32_e32 v11, v11                                 // 000000002460: 7E16110B
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000002464: BF870193
	v_rndne_f32_e32 v6, v6                                     // 000000002468: 7E0C4706
	v_and_b32_e32 v8, 0xff0000, v8                             // 00000000246C: 361010FF 00FF0000
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)// 000000002474: BF870214
	v_rndne_f32_e32 v13, v13                                   // 000000002478: 7E1A470D
	v_lshlrev_b32_e32 v11, 8, v11                              // 00000000247C: 30161688
	v_mul_f32_e32 v9, v9, v14                                  // 000000002480: 10121D09
	v_cvt_i32_f32_e32 v6, v6                                   // 000000002484: 7E0C1106
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000002488: BF870194
	v_cvt_i32_f32_e32 v13, v13                                 // 00000000248C: 7E1A110D
	v_rndne_f32_e32 v9, v9                                     // 000000002490: 7E124709
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000002494: BF870091
	v_cvt_i32_f32_e32 v9, v9                                   // 000000002498: 7E121109
	v_perm_b32 v6, v9, v6, 0x40c0c00                           // 00000000249C: D6440006 03FE0D09 040C0C00
	s_delay_alu instid0(VALU_DEP_4)                            // 0000000024A8: BF870004
	v_perm_b32 v9, v13, v10, 0x40c0c00                         // 0000000024AC: D6440009 03FE150D 040C0C00
	v_and_b32_e32 v10, 0xff00, v11                             // 0000000024B8: 361416FF 0000FF00
	v_and_b32_e32 v11, 0xff0000, v12                           // 0000000024C0: 361618FF 00FF0000
	v_add_co_u32 v12, vcc_lo, s20, v2                          // 0000000024C8: D7006A0C 00020414
	v_add_co_ci_u32_e32 v13, vcc_lo, s21, v3, vcc_lo           // 0000000024D0: 401A0615
	v_or3_b32 v2, v6, v7, v8                                   // 0000000024D4: D6580002 04220F06
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)// 0000000024DC: BF870223
	v_add_co_u32 v6, vcc_lo, v12, v0                           // 0000000024E0: D7006A06 0002010C
	v_or3_b32 v3, v9, v10, v11                                 // 0000000024E8: D6580003 042E1509
	v_add_co_ci_u32_e32 v7, vcc_lo, 0, v13, vcc_lo             // 0000000024F0: 400E1A80
	global_store_b64 v[6:7], v[2:3], off                       // 0000000024F4: DC6E0000 007C0206
	s_and_b32 exec_lo, exec_lo, s1                             // 0000000024FC: 8B7E017E
	s_cbranch_execz 5                                          // 000000002500: BFA50005 <attn_prep_24_4_256_64_8204_11_k4jv4+0x2518>
	v_add_co_u32 v2, vcc_lo, s22, v4                           // 000000002504: D7006A02 00020816
	v_add_co_ci_u32_e32 v3, vcc_lo, s23, v5, vcc_lo            // 00000000250C: 40060A17
	global_store_b32 v[2:3], v1, off                           // 000000002510: DC6A0000 007C0102
	s_endpgm                                                   // 000000002518: BFB00000
